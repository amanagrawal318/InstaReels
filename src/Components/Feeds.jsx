...
const Feeds = (props) => {
  ...
  function cb(entries) {
    ...
    entries.forEach(entry => {
      let child = entry.target.children[1]?entry.target.children[1]:entry.target.children[0];      // play(); => async
      // pause(); => sync
    // console.log(child);
  ...
  return (
    <div style={{margin:"5px"}}>
      ...
      <div className="uploadVideo">
        <div>
          {/*<input type="file" onChange={handleInputFile} id="uploadvideo" style={{ display: 'none' }}/>
          <label htmlFor="uploadvideo">
            <Button onClick={handleUploadFile} variant="contained" color="secondary" startIcon={<PhotoCamera></PhotoCamera>}>
             Upload
            </Button>
          </label>*/}
        <input type="file" id="contained-button-file"  onChange={handleInputFile} style={{ display: 'none' }}/>
      <label htmlFor="contained-button-file">
        <Button variant="outline"   color="secondary" component="span" startIcon={<PhotoCamera></PhotoCamera>} style={{ margin: "5px",    
